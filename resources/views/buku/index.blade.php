...
<div class="bg-white rounded-lg shadow overflow-hidden mb-4">
    <div class="p-4">
        <form action="{{ route('buku.index') }}" method="GET" class="flex gap-2">
            <div class="flex-1">
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari berdasarkan kode buku, judul, pengarang, atau penerbit..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            </div>
            ...
            <a href="{{ route('buku.index') }}" class="px-6 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 focus:ring-4 focus:ring-gray-300 font-medium whitespace-nowrap {{ request('search') ? '' : 'invisible' }}">
                Reset
            </a>
        </form>
    </div>
