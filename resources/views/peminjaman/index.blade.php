...
<div class="bg-white rounded-lg shadow overflow-hidden mb-4">
    <div class="p-4">
        <form action="{{ route('peminjaman.index') }}" method="GET" class="flex gap-2">
            ...
            <a href="{{ route('peminjaman.index') }}" class="px-6 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 focus:ring-4 focus:ring-gray-300 font-medium whitespace-nowrap {{ request('search') ? '' : 'invisible' }}">
                Reset
            </a>
        </form>
    </div>
